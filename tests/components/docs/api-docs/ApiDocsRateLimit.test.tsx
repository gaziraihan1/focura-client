...
describe("ApiDocsRateLimit", () => {
  it("renders rate limit tiers and headers", async () => {
    const { ApiDocsRateLimit } = await import("@/components/docs/api-docs/ApiDocsRateLimit");
    render(<ApiDocsRateLimit />);
    expect(screen.getByText("Rate Limits")).toBeInTheDocument();
    expect(screen.getByText("Limit Tiers by Endpoint")).toBeInTheDocument();
