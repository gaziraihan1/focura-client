...
describe("ApiDocsSection", () => {
  it("renders section with endpoint count", async () => {
    const { ApiDocsSection } = await import("@/components/docs/api-docs/ApiDocsSection");
    render(
      <ApiDocsSection
        section={{
          id: "test-section",
  ...
  it("renders plural endpoint count", async () => {
    const { ApiDocsSection } = await import("@/components/docs/api-docs/ApiDocsSection");
    render(
      <ApiDocsSection
        section={{
          ...
          description: "Desc",
          endpoints: [
            { id: "ep1", method: "GET", path: "/1", summary: "A", description: "A", auth: "public", responses: [{ status: 200, description: "OK" }], examples: [{ label: "cURL", code: "curl" }] },
            { id: "ep2", method: "POST", path: "/2", summary: "B", description: "B", auth: "auth", responses: [{ status: 200, description: "OK" }], examples: [{ label: "cURL", code: "curl" }] },
          ],
        }}
        firstOpen
      />
