...
describe("ApiDocsEndPointCard", () => {
  it("renders endpoint via ApiDocsSection (integration)", async () => {
          ...
          endpoints: [
            {
              ...
              auth: "public",
              responses: [{ status: 200, description: "OK" }],
              examples: [{ label: "cURL", code: "curl /api/test" }],
            },
            {
              id: "ep2",
              method: "POST",
              ...
              auth: "auth",
              deprecated: true,
              bodyFields: [{ name: "name", type: "string", required: true, description: "Name" }],
              responses: [{ status: 201, description: "Created" }],
              examples: [{ label: "cURL", code: "curl -X POST" }],
            },
          ],
    ...
    expect(screen.getByText("/api/submit")).toBeInTheDocument();
