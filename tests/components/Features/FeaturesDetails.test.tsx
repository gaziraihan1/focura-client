...
describe('FeaturesDetails', () => {
  it('renders the section heading', () => {
    render(<FeaturesDetails />)
    expect(screen.getByText('Powerful features designed for modern teams')).toBeInTheDocument()
  })

  it('renders feature titles', () => {
    render(<FeaturesDetails />)
    expect(screen.getByText('Visualize your workflow clearly')).toBeInTheDocument()
    expect(screen.getByText('Lightning-fast collaboration')).toBeInTheDocument()
    expect(screen.getByText('Smart automation for busy teams')).toBeInTheDocument()
  })
})
