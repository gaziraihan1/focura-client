...
describe('FeaturesHighlights', () => {
  it('renders the section heading', () => {
    render(<FeaturesHighlights />)
    expect(screen.getByText('Everything you need in one powerful platform')).toBeInTheDocument()
  })

  it('renders all 6 highlight cards', () => {
    render(<FeaturesHighlights />)
    expect(screen.getByText('Streamlined workflows')).toBeInTheDocument()
    ...
    expect(screen.getByText('Modular structure')).toBeInTheDocument()
    expect(screen.getByText('Automated productivity')).toBeInTheDocument()
  })
})
