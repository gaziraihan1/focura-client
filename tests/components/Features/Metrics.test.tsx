...
describe('Metrics', () => {
  ...
  it('renders metric labels', () => {
    render(<Metrics />)
    expect(screen.getByText('Faster Task Completion')).toBeInTheDocument()
    expect(screen.getByText('Less Context Switching')).toBeInTheDocument()
    expect(screen.getByText('Daily Time Saved')).toBeInTheDocument()
    expect(screen.getByText('Team Satisfaction Score')).toBeInTheDocument()
  })
})
