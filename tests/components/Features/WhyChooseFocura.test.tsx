...
describe('WhyChooseFocura', () => {
  it('renders the section heading', () => {
    render(<WhyChooseFocura />)
    expect(screen.getByText(/Why teams choose/)).toBeInTheDocument()
  })

  it('renders all 6 reason cards', () => {
    render(<WhyChooseFocura />)
    expect(screen.getByText('Lightning-fast workflow')).toBeInTheDocument()
    expect(screen.getByText('Effortless collaboration')).toBeInTheDocument()
    ...
    expect(screen.getByText('A beautiful experience')).toBeInTheDocument()
  })
})
