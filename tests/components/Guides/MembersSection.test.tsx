...
import { MembersSection } from '@/components/Guides/MembersSection'
...
describe('MembersSection', () => {
  ...
  it('renders inviting members steps', () => {
    render(<MembersSection />)
    expect(screen.getByText('Go to Settings \u2192 Members')).toBeInTheDocument()
