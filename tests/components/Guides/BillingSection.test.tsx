...
import { BillingSection } from '@/components/Guides/MiscSection'

describe('BillingSection', () => {
  it('renders "Accessing billing"', () => {
    render(<BillingSection />)
    expect(screen.getByText('Accessing billing')).toBeInTheDocument()
  })

  it('renders changing plan steps', () => {
    render(<BillingSection />)
    expect(screen.getByText('Find Billing in the workspace navigation')).toBeInTheDocument()
    expect(screen.getByText('Select a new plan')).toBeInTheDocument()
    expect(screen.getByText('Confirm the change')).toBeInTheDocument()
  })

  it('renders invoices info', () => {
    render(<BillingSection />)
