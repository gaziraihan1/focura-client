...
import { MeetingsSection } from '@/components/Guides/MiscSection'

describe('MeetingsSection', () => {
  it('renders "What are meetings?"', () => {
    render(<MeetingsSection />)
    expect(screen.getByText('What are meetings?')).toBeInTheDocument()
  })

  it('renders meeting steps', () => {
    render(<MeetingsSection />)
    expect(screen.getByText('Open Meetings')).toBeInTheDocument()
    expect(screen.getByText('Create a new meeting')).toBeInTheDocument()
