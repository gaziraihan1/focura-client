...
import { ActivitySection } from '@/components/Guides/ActivitySection'

describe('ActivitySection', () => {
  it('renders "What is activity tracking?"', () => {
    render(<ActivitySection />)
    expect(screen.getByText('What is activity tracking?')).toBeInTheDocument()
  })

  it('renders tracked events', () => {
    render(<ActivitySection />)
