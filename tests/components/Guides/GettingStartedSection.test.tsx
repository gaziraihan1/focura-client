...
import { GettingStartedSection } from '@/components/Guides/GettingStartedSection'

describe('GettingStartedSection', () => {
  it('renders the intro text', () => {
    render(<GettingStartedSection />)
    expect(screen.getByText(/Focura is a project management platform/)).toBeInTheDocument()
  })
