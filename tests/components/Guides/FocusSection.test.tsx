...
import { FocusSection } from '@/components/Guides/MiscSection'

describe('FocusSection', () => {
  it('renders "What is Focus Mode?"', () => {
    render(<FocusSection />)
    expect(screen.getByText('What is Focus Mode?')).toBeInTheDocument()
  })

  it('renders focus session steps', () => {
    render(<FocusSection />)
    expect(screen.getByText('Open a task')).toBeInTheDocument()
    expect(screen.getByText(/Click "Start Focus Session"/)).toBeInTheDocument()
  })

  it('renders focus stats info', () => {
    render(<FocusSection />)
    expect(screen.getByText('Track your deep work over time')).toBeInTheDocument()
  })
})
