...
import { VotingSection } from '@/components/Guides/MiscSection'

describe('VotingSection', () => {
  it('renders "What is Feature Voting?"', () => {
    render(<VotingSection />)
    expect(screen.getByText('What is Feature Voting?')).toBeInTheDocument()
  })

  it('renders submission steps', () => {
    render(<VotingSection />)
    expect(screen.getByText('Go to Feature Voting')).toBeInTheDocument()
    expect(screen.getByText('Submit your idea')).toBeInTheDocument()
    expect(screen.getByText('Gather votes')).toBeInTheDocument()
  })

  it('renders voting tips', () => {
    render(<VotingSection />)
