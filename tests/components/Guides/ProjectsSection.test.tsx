...
import { ProjectsSection } from '@/components/Guides/ProjectSection'

describe('ProjectsSection', () => {
  it('renders "What is a project?"', () => {
    render(<ProjectsSection />)
    expect(screen.getByText('What is a project?')).toBeInTheDocument()
  })

  it('renders project creation steps', () => {
    render(<ProjectsSection />)
    expect(screen.getByText(/Click "New Project"/)).toBeInTheDocument()
    expect(screen.getByText('Fill in project details')).toBeInTheDocument()
    expect(screen.getByText('Add members')).toBeInTheDocument()
  })

  it('renders viewing modes', () => {
    render(<ProjectsSection />)
    expect(screen.getByText('Viewing modes')).toBeInTheDocument()
    expect(screen.getByText('Project Mode')).toBeInTheDocument()
