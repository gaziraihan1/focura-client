...
import { LabelsSection } from '@/components/Guides/LabelsSection'

describe('LabelsSection', () => {
  it('renders "What are labels?"', () => {
    render(<LabelsSection />)
    expect(screen.getByText('What are labels?')).toBeInTheDocument()
  })

  it('renders label examples', () => {
    render(<LabelsSection />)
