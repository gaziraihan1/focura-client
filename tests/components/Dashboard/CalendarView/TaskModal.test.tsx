...
describe('CalendarView/TaskModal – TaskModalHeader', () => {
  it('renders title', async () => {
    const { TaskModalHeader } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskModalHeader')
...
describe('CalendarView/TaskModal – TaskDescription', () => {
  it('returns null when no description', async () => {
    const { TaskDescription } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskDescription')
...
describe('CalendarView/TaskModal – TaskTimeDetails', () => {
  it('renders created date', async () => {
    const { TaskTimeDetails } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskTimeDetails')
...
describe('CalendarView/TaskModal – TaskPeopleSection', () => {
  it('renders creator name', async () => {
    const { TaskPeopleSection } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskPeopleSection')
...
describe('CalendarView/TaskModal – TaskProjectSection', () => {
  it('returns null when no project', async () => {
    const { TaskProjectSection } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskProjectSection')
...
describe('CalendarView/TaskModal – TaskActivityStats', () => {
  it('renders counts', async () => {
    const { TaskActivityStats } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskActivityStats')
...
describe('CalendarView/TaskModal – TaskModalContent', () => {
  it('renders all sub-sections', async () => {
    const { TaskModalContent } = await import('@/components/Dashboard/CalendarView/TaskModal/TaskModalContent')
    render(
      <TaskModalContent
...
describe('CalendarView/TaskModal – UserAvatar', () => {
  it('renders initials when no image', async () => {
    const UserAvatar = (await import('@/components/Dashboard/CalendarView/TaskModal/UserAvatar')).default
