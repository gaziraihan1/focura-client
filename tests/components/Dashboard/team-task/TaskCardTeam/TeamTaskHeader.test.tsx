...
describe("TeamTaskHeader", () => {
  it("renders title and description", async () => {
    const { TeamTaskHeader } = await import("@/components/dashboard/team-task/TaskCardTeam/TeamTaskHeader");
    render(
      <TeamTaskHeader title="My Task" description="A task description" priority="HIGH" />
    );
  ...
  it("renders without description", async () => {
    const { TeamTaskHeader } = await import("@/components/dashboard/team-task/TaskCardTeam/TeamTaskHeader");
    render(<TeamTaskHeader title="Task" priority="LOW" />);
