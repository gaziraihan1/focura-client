...
vi.mock('@/components/dashboard/storage/overview/StorageSummaryCards', () => ({ StorageSummaryCards: () => <div data-testid="summary-cards" /> }));
vi.mock('@/components/dashboard/storage/overview/MyContributionCard', () => ({ MyContributionCard: () => <div data-testid="my-contribution" /> }));
vi.mock('@/components/dashboard/storage/overview/UserContributionsTable', () => ({ UserContributionsTable: () => <div data-testid="user-contributions" /> }));
vi.mock('@/components/dashboard/storage/overview/StorageBreakdownChart', () => ({ StorageBreakdownChart: () => <div data-testid="breakdown-chart" /> }));
vi.mock('@/components/dashboard/storage/overview/StorageTrendChart', () => ({ StorageTrendChart: () => <div data-testid="trend-chart" /> }));
vi.mock('@/components/dashboard/storage/overview/LargestFilesTable', () => ({ LargestFilesTable: () => <div data-testid="largest-files" /> }));
vi.mock('@/components/dashboard/storage/overview/PlanComparison', () => ({ PlanComparison: () => <div data-testid="plan-comparison" /> }));
