...
describe('Workspaces/project/Settings – Avatar', () => {
  it('renders name initials', async () => {
    const { Avatar } = await import('@/components/Dashboard/Workspaces/project/Settings/Avatar')
