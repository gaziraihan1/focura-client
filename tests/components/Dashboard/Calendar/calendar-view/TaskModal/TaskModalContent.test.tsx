...
vi.mock('@/components/dashboard/calendar/calendar-view/TaskModal/TaskPlanSection', () => ({
  TaskPlanSection: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="task-plan-section" />,
}));

vi.mock('@/components/dashboard/calendar/calendar-view/TaskModal/TaskFocusSection', () => ({
...
// ═══════════════════════════════════════════════════════════════════════════════
import { TaskModalContent } from '@/components/dashboard/calendar/calendar-view/TaskModal/TaskModalContent';
