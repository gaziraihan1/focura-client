...
describe("InvitationHeader", () => {
  it("renders workspace name and invitation header", async () => {
    const { default: InvitationHeader } = await import("@/components/Dashboard/Invitation/InvitationCard/InvitationHeader");
    render(
      <InvitationHeader
        invitation={{
          email: "u@test.com",
          ...
          workspace: { name: "My Workspace", slug: "my-ws" },
        }}
      />
    );
