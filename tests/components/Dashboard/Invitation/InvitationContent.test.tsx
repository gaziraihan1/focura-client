...
describe("InvitationContent", () => {
  it("renders description when provided", async () => {
    const { default: InvitationContent } = await import("@/components/Dashboard/Invitation/InvitationCard/InvitationContent");
    render(
      <InvitationContent
        invitation={{
          email: "a@b.com",
          ...
          workspace: { name: "W", slug: "w", description: "Great workspace" },
        }}
        isAccepting={false}
        localError={null}
        onAccept={vi.fn()}
    ...
    expect(screen.getByText("Great workspace")).toBeInTheDocument();
  });

  it("renders localError when present", async () => {
    const { default: InvitationContent } = await import("@/components/Dashboard/Invitation/InvitationCard/InvitationContent");
    render(
      <InvitationContent
        invitation={{
