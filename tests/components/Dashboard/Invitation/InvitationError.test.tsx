...
describe("InvitationError", () => {
  it("renders error message", async () => {
    const { default: InvitationError } = await import("@/components/Dashboard/Invitation/InvitationCard/InvitationError");
    render(<InvitationError localError="Something went wrong" />);
