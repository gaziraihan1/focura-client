...
describe("TeamTaskAssignees", () => {
  it("renders assignee avatars", async () => {
    const { TeamTaskAssignees } = await import("@/components/Dashboard/TeamTask/TaskCardTeam/TeamTaskAssignees");
    render(
      <TeamTaskAssignees
        assignees={[
  ...
  it("shows +N when more than 4 assignees", async () => {
    const { TeamTaskAssignees } = await import("@/components/Dashboard/TeamTask/TaskCardTeam/TeamTaskAssignees");
    render(
      <TeamTaskAssignees
        assignees={[
