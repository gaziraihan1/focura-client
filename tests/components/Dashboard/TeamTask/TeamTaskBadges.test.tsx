...
describe("TeamTaskBadges", () => {
  it("renders badges with status and time info", async () => {
    const { TeamTaskBadges } = await import("@/components/Dashboard/TeamTask/TaskCardTeam/TeamTaskBadges");
    render(
      <TeamTaskBadges
        task={{
          id: "1",
        ...
        timeInfo={{ isOverdue: false, hoursUntilDue: null }}
        timeProgress={null}
      />
    );
