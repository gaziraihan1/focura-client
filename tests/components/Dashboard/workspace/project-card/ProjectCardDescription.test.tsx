...
vi.mock('@/components/dashboard/tasks/all-tasks/workspace-tasks/TaskCardParts', () => ({
...
vi.mock('@/components/dashboard/workspace/members/ProjectMembersPanel', () => ({
...
// ─── Imports under test ──────────────────────────────────────────────────────
import { ProjectCardDescription } from '@/components/dashboard/workspace/project-card/ProjectCardDescription'
