...
import { MembersTab } from '@/components/dashboard/workspace/project-overview/Settings/MembersTab';
...
vi.mock('@/components/dashboard/projects/project-details/AddMemberModal', () => ({
  default: () => <div data-testid="add-member-modal" />,
}));

vi.mock('@/components/dashboard/workspace/project-overview/Settings/RoleDropdown', () => ({
  RoleDropdown: () => <div data-testid="role-dropdown" />,
}));

vi.mock('@/components/dashboard/workspace/project-overview/Settings/Avatar', () => ({
  Avatar: ({ name, ...props }: Record<string, unknown>) => <div data-testid="avatar" data-name={name} />,
}));

vi.mock('@/components/dashboard/workspace/project-overview/Settings/RoleBadge', () => ({
