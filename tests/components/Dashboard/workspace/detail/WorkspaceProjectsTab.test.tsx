...
vi.mock('@/components/dashboard/workspace/project-card/ProjectCardHeader', () => ({
...
vi.mock('@/components/dashboard/workspace/project-card/ProjectCardDescription', () => ({
  ProjectCardDescription: (props: Record<string, unknown>) => (
    <div data-testid="project-card-description" data-desc={props.description} />
  ),
}))

vi.mock('@/components/dashboard/workspace/project-card/ProjectCardStats', () => ({
...
vi.mock('@/components/dashboard/workspace/project-card/ProjectCardFooter', () => ({
...
import { WorkspaceProjectsTab } from '@/components/dashboard/workspace/detail/WorkspaceProjectsTab'
