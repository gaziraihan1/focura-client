...
import { ProjectListItem } from '@/components/dashboard/projects/all-projects/ProjectListItem'
...
vi.mock('@/components/dashboard/projects/all-projects/WorkspaceProjects/AceessDeniedModal', () => ({
