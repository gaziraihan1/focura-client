...
describe('AllTasks/TaskQouta – ProgressRing', () => {
  it('renders SVG circles', async () => {
    const { ProgressRing } = await import('@/components/Dashboard/AllTasks/TaskQouta/ProgressRing')
...
describe('AllTasks/TaskQouta – QoutaSkeleton', () => {
  it('renders skeleton', async () => {
    const { QuotaSkeleton } = await import('@/components/Dashboard/AllTasks/TaskQouta/QoutaSkeleton')
...
describe('AllTasks/TaskQouta – StartPill (StatPill)', () => {
  it('renders label and value', async () => {
    const { StatPill } = await import('@/components/Dashboard/AllTasks/TaskQouta/StartPill')
