...
import { VisibilityBadge } from '@/components/dashboard/meeting-details/VisibilityBadge'
import { InfoRow } from '@/components/dashboard/meeting-details/InfoRow'
import { DetailCard } from '@/components/dashboard/meeting-details/DetailCard'
import { MeetingDetailsSkeleton } from '@/components/dashboard/meeting-details/MeetingDetailsSkeleton'
import { HostChip } from '@/components/dashboard/meeting-details/HostChip'
import { AttendeeAvatar } from '@/components/dashboard/meeting-details/AttendeeAvatar'
...
vi.mock('next/image', () => ({
  default: (props: React.ImgHTMLAttributes<HTMLImageElement>) => <img alt="" data-testid="next-image" {...props} />,
}))
