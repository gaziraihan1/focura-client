...
describe('ProjectDetails/TaskModal – TaskTitleInput', () => {
  it('renders title input', async () => {
    const { TaskTitleInput } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskTitleInput')
...
describe('ProjectDetails/TaskModal – TaskDescriptionInput', () => {
  it('renders textarea', async () => {
    const { TaskDescriptionInput } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskDescriptionInput')
...
describe('ProjectDetails/TaskModal – TaskPriorityPicker', () => {
  it('renders all priority options', async () => {
    const { TaskPriorityPicker } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskPriorityPicker')
...
describe('ProjectDetails/TaskModal – TaskDueDateInput', () => {
  it('renders date input', async () => {
    const { TaskDueDateInput } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskDueDateInput')
...
describe('ProjectDetails/TaskModal – TaskStartDateInput', () => {
  it('renders date input', async () => {
    const { TaskStartDateInput } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskStartDateInput')
...
describe('ProjectDetails/TaskModal – TaskEstimatedHoursInput', () => {
  it('renders number input', async () => {
    const { TaskEstimatedHoursInput } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskEstimatedHoursInput')
...
describe('ProjectDetails/TaskModal – TaskIntentPicker', () => {
  it('renders intent options', async () => {
    const { TaskIntentPicker } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskIntentPicker')
...
describe('ProjectDetails/TaskModal – TaskAssigneePicker', () => {
  ...
  it('renders members', async () => {
    const { TaskAssigneePicker } = await import('@/components/Dashboard/ProjectDetails/TaskModal/TaskAssigneePicker')
