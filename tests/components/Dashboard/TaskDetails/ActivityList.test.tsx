...
describe('TaskDetails/ActivityList – EmptyState', () => {
  it('renders no activity message', async () => {
    const { EmptyState } = await import('@/components/Dashboard/TaskDetails/ActivityList/EmptyState')
    render(<EmptyState />)
...
describe('TaskDetails/ActivityList – ActivityIcon', () => {
  it('renders Plus for "Plus"', async () => {
    const { ActivityIcon } = await import('@/components/Dashboard/TaskDetails/ActivityList/ActivityIcon')
...
describe('TaskDetails/ActivityList – UserAvatar', () => {
  it('renders avatar with user name', async () => {
    const { UserAvatar } = await import('@/components/Dashboard/TaskDetails/ActivityList/UserAvatar')
...
describe('TaskDetails/ActivityList – ActivityItem', () => {
  ...
  it('renders user name', async () => {
    const { ActivityItem } = await import('@/components/Dashboard/TaskDetails/ActivityList/ActivityItem')
...
describe('TaskDetails/ActivityList – DateGroup', () => {
  it('renders date header', async () => {
    const { DateGroup } = await import('@/components/Dashboard/TaskDetails/ActivityList/DateGroup')
