...
describe('TaskDetails/TaskSidebar – StatusSelector', () => {
  it('renders lock when cannot change status', async () => {
    const { StatusSelector } = await import('@/components/Dashboard/TaskDetails/TaskSidebar/StatusSelector')
...
describe('TaskDetails/TaskSidebar – TaskAssigneesList', () => {
  it('returns null when no assignees', async () => {
    const { TaskAssigneesList } = await import('@/components/Dashboard/TaskDetails/TaskSidebar/TaskAssigneesList')
...
describe('TaskDetails/TaskSidebar – TaskTimestamps', () => {
  it('renders created date', async () => {
    const { TaskTimestamps } = await import('@/components/Dashboard/TaskDetails/TaskSidebar/TaskTimeStamps')
...
describe('TaskDetails/TaskSidebar – PriorityDisplay', () => {
  it('renders priority', async () => {
    const { PriorityDisplay } = await import('@/components/Dashboard/TaskDetails/TaskSidebar/PriorityDisplay')
