...
import { CommentItem } from '@/components/dashboard/task-details/tabs/CommentsList/CommentItem';
...
vi.mock('@/components/dashboard/task-details/tabs/CommentsList/CommentContent', () => ({
  CommentContent: ({ content }: { content: string }) => <div data-testid="comment-content">{content}</div>,
}));
vi.mock('@/components/dashboard/task-details/tabs/CommentsList/RelativeTime', () => ({
