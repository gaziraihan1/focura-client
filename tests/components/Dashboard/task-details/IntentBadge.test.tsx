...
describe('TaskDetails/IntentBadge', () => {
  it('renders default EXECUTION badge', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge />)
    expect(screen.getByText('Do Work')).toBeInTheDocument()
  })
  it('renders PLANNING badge', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge intent="PLANNING" />)
    expect(screen.getByText('Think & Plan')).toBeInTheDocument()
  })
  it('renders REVIEW badge', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge intent="REVIEW" />)
    expect(screen.getByText('Review')).toBeInTheDocument()
  })
  it('renders LEARNING badge', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge intent="LEARNING" />)
    expect(screen.getByText('Learn')).toBeInTheDocument()
  })
  it('renders COMMUNICATION badge', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
  ...
  it('renders size sm', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge intent="EXECUTION" size="sm" />)
    expect(screen.getByText('Do Work')).toBeInTheDocument()
  })
  it('renders size lg', async () => {
    const { IntentBadge } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentBadge intent="EXECUTION" size="lg" />)
    expect(screen.getByText('Do Work')).toBeInTheDocument()
  })
})

describe('TaskDetails/IntentBadge – IntentCard', () => {
  it('renders intent card', async () => {
    const { IntentCard } = await import('@/components/dashboard/task-details/IntentBadge')
    render(<IntentCard intent="EXECUTION" />)
    expect(screen.getByText('Do Work')).toBeInTheDocument()
    expect(screen.getByText('Active implementation and building')).toBeInTheDocument()
  })
  it('renders PLANNING card', async () => {
    const { IntentCard } = await import('@/components/dashboard/task-details/IntentBadge')
