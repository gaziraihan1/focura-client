...
vi.mock('@/components/dashboard/task-details/TaskHeader', () => ({
  TaskHeader: () => <div data-testid="task-header" />,
}));

vi.mock('@/components/dashboard/task-details/FocusSessionCard', () => ({
  FocusSessionCard: () => <div data-testid="focus-session-card" />,
}));

vi.mock('@/components/dashboard/task-details/TimeEntryCard', () => ({
  TimeEntryCard: () => <div data-testid="time-entry-card" />,
}));

vi.mock('@/components/dashboard/task-details/FocusRequirementsCard', () => ({
  FocusRequirementsCard: () => <div data-testid="focus-requirements-card" />,
}));

vi.mock('@/components/dashboard/task-details/TimeTrackingCard', () => ({
  TimeTrackingCard: () => <div data-testid="time-tracking-card" />,
}));

vi.mock('@/components/dashboard/task-details/IntentBadge', () => ({
  IntentBadge: () => <div data-testid="intent-badge" />,
}));

let mockMainLayoutProps: Record<string, unknown> | null = null;
vi.mock('@/components/dashboard/task-details/TaskDetailsMainLayout', () => ({
