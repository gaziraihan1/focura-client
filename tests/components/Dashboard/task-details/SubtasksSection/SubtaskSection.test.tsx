...
import { SubtaskSection } from '@/components/dashboard/task-details/SubtasksSection/SubtaskSection';
...
vi.mock('@/components/dashboard/task-details/SubtasksSection/SubtaskProgress', () => ({ SubtaskProgress: () => <div data-testid="subtask-progress" /> }));
vi.mock('@/components/dashboard/task-details/SubtasksSection/SubtaskForm', () => ({ SubtaskForm: () => <div data-testid="subtask-form" /> }));
vi.mock('@/components/dashboard/task-details/SubtasksSection/SubtaskList', () => ({ SubtaskList: () => <div data-testid="subtask-list" /> }));
vi.mock('@/components/dashboard/task-details/SubtasksSection/SubtaskEmptyState', () => ({ SubtaskEmptyState: () => <div data-testid="subtask-empty" /> }));
