...
describe('AllTasks/TaskQouta – ProgressRing', () => {
  it('renders SVG circles', async () => {
    const { ProgressRing } = await import('@/components/dashboard/tasks/all-tasks/TaskQouta/ProgressRing')
...
describe('AllTasks/TaskQouta – QoutaSkeleton', () => {
  it('renders skeleton', async () => {
    const { QuotaSkeleton } = await import('@/components/dashboard/tasks/all-tasks/TaskQouta/QoutaSkeleton')
    const { container } = render(<QuotaSkeleton />)
    expect(container.querySelector('.animate-pulse')).toBeInTheDocument()
  })
})

describe('AllTasks/TaskQouta – StartPill (StatPill)', () => {
  it('renders label and value', async () => {
    const { StatPill } = await import('@/components/dashboard/tasks/all-tasks/TaskQouta/StartPill')
