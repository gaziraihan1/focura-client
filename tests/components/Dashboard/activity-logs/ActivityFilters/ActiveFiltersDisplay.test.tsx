...
vi.mock('@/components/dashboard/activity-logs/ActivityFilters/ActiveFiltersBadge', () => ({
...
import { ActiveFiltersDisplay } from '@/components/dashboard/activity-logs/ActivityFilters/ActiveFiltersDisplay';
