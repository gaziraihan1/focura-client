...
import { PrivacyRightsGrid } from '@/components/PrivacyAndPolicy/PrivacyRightsGrid'

describe('PrivacyRightsGrid', () => {
  it('renders all 8 rights', () => {
    render(<PrivacyRightsGrid />)
    ...
    expect(screen.getByText('Right to Complain')).toBeInTheDocument()
