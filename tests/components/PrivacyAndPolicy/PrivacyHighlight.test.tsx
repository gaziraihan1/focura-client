...
import { PrivacyHighlight } from '@/components/PrivacyAndPolicy/PrivacyHighlight'

describe('PrivacyHighlight', () => {
  it('renders with default info variant', () => {
    render(<PrivacyHighlight>Info text</PrivacyHighlight>)
    expect(screen.getByText('Info text')).toBeInTheDocument()
  })

  it('renders with warning variant', () => {
    render(<PrivacyHighlight variant="warning">Warning text</PrivacyHighlight>)
    expect(screen.getByText('Warning text')).toBeInTheDocument()
  })

  it('renders with success variant', () => {
    render(<PrivacyHighlight variant="success">Success text</PrivacyHighlight>)
