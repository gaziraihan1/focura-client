...
describe('PrivacyHero', () => {
  ...
  it('renders the description text', () => {
    render(<PrivacyHero />)
    expect(screen.getByText(/We are committed to protecting/)).toBeInTheDocument()
  })

  it('renders effective date and last updated', () => {
    render(<PrivacyHero />)
    expect(screen.getByText(/Effective: January 1, 2026/)).toBeInTheDocument()
    expect(screen.getByText(/Last Updated: April 24, 2026/)).toBeInTheDocument()
  })

  it('renders GDPR & CCPA Compliant', () => {
    render(<PrivacyHero />)
