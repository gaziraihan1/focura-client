...
import { CookiesHighlight } from '@/components/public/cookies/CookiesHighlight'

describe('CookiesHighlight', () => {
  it('renders info variant', () => {
    render(<CookiesHighlight variant="info">Info</CookiesHighlight>)
    expect(screen.getByText('Info')).toBeInTheDocument()
  })

  it('renders warning variant', () => {
    render(<CookiesHighlight variant="warning">Warn</CookiesHighlight>)
    expect(screen.getByText('Warn')).toBeInTheDocument()
  })

  it('renders success variant', () => {
    render(<CookiesHighlight variant="success">OK</CookiesHighlight>)
