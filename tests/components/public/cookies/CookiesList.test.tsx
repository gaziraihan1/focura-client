...
import { CookiesList } from '@/components/public/cookies/CookiesList'

describe('CookiesList', () => {
  it('renders items as unordered list by default', () => {
    const { container } = render(<CookiesList items={['A', 'B']} />)
    expect(container.querySelector('ul')).toBeInTheDocument()
  })

  it('renders items as ordered list when specified', () => {
    const { container } = render(<CookiesList items={['A', 'B']} ordered />)
