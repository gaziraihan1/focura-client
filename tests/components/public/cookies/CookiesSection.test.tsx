...
import { CookiesSection } from '@/components/public/cookies/CookiesSection'
...
describe('CookiesSection', () => {
  it('renders section with id, title, and content', () => {
    ...
    expect(screen.getByText('My Cookie Section')).toBeInTheDocument()
    expect(screen.getByText('Section 2')).toBeInTheDocument()
    expect(screen.getByText('Cookie content')).toBeInTheDocument()
  })
})
