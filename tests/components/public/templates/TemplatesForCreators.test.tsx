...
import TemplatesForCreators from '@/components/public/templates/TemplatesForCreators'

describe('TemplatesForCreators', () => {
  it('renders the heading', () => {
    render(<TemplatesForCreators />)
    expect(screen.getByText('Build your own templates.')).toBeInTheDocument()
  })

  it('renders all feature cards', () => {
    render(<TemplatesForCreators />)
    expect(screen.getByText('Save any project as a template')).toBeInTheDocument()
    expect(screen.getByText('Private workspace templates')).toBeInTheDocument()
    expect(screen.getByText('Share publicly with the community')).toBeInTheDocument()
    expect(screen.getByText('Ratings and usage stats')).toBeInTheDocument()
  })
