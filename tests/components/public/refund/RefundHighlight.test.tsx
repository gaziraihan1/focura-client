...
import { RefundHighlight } from '@/components/public/refund/RefundHighlight'

describe('RefundHighlight', () => {
  it('renders info', () => {
    render(<RefundHighlight variant="info">Info text</RefundHighlight>)
    expect(screen.getByText('Info text')).toBeInTheDocument()
  })

  it('renders warning', () => {
    render(<RefundHighlight variant="warning">Warning text</RefundHighlight>)
    expect(screen.getByText('Warning text')).toBeInTheDocument()
  })

  it('renders success', () => {
    render(<RefundHighlight variant="success">Success text</RefundHighlight>)
