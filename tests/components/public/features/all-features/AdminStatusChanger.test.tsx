...
import { AdminStatusChanger } from '@/components/public/features/all-features/AdminStatusChanger'

describe('AdminStatusChanger', () => {
  const baseFeature = {
    id: 'f1',
    title: 'Test',
  ...
  it('renders settings button', () => {
    render(<AdminStatusChanger feature={baseFeature} />)
  ...
  it('shows current status indicator', () => {
    ...
    expect(currentIndicators.length).toBeGreaterThanOrEqual(1)
  })
})
