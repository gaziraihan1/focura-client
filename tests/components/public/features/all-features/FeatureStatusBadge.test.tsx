...
import { FeatureStatusBadge } from '@/components/public/features/all-features/FeatureStatusBadge'
...
describe('FeatureStatusBadge', () => {
  ...
  it('renders Approved status', () => {
    render(<FeatureStatusBadge status="APPROVED" />)
    expect(screen.getByText('Approved')).toBeInTheDocument()
  })

  it('renders Rejected status', () => {
    render(<FeatureStatusBadge status="REJECTED" />)
  ...
  it('renders Completed status', () => {
    render(<FeatureStatusBadge status="COMPLETED" />)
