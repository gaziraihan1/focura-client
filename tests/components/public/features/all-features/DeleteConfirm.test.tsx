...
import { DeleteConfirm } from '@/components/public/features/all-features/DeleteConfirm'

describe('DeleteConfirm', () => {
  it('renders the delete confirmation dialog', () => {
    render(<DeleteConfirm title="My Feature" isDeleting={false} onConfirm={vi.fn()} onCancel={vi.fn()} />)
  ...
  it('calls onConfirm when delete button is clicked', () => {
    ...
    render(<DeleteConfirm title="Feature" isDeleting={false} onConfirm={onConfirm} onCancel={vi.fn()} />)
  ...
  it('calls onCancel when cancel button is clicked', () => {
    ...
    render(<DeleteConfirm title="Feature" isDeleting={false} onConfirm={vi.fn()} onCancel={onCancel} />)
    fireEvent.click(screen.getByText('Cancel'))
    expect(onCancel).toHaveBeenCalled()
  })

  it('shows "Deleting\u2026" when isDeleting is true', () => {
    render(<DeleteConfirm title="Feature" isDeleting={true} onConfirm={vi.fn()} onCancel={vi.fn()} />)
