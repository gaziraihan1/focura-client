...
describe("WorkspaceLayoutHeader", () => {
  it("renders search input and theme switcher", async () => {
    const { WorkspaceLayoutHeader } = await import("@/components/dashboard/workspace/layout/WorkspaceLayoutHeader");
    render(
    ...
    expect(screen.getByPlaceholderText("Search or press Cmd+K")).toBeInTheDocument();
    expect(screen.getByTestId("theme-switcher")).toBeInTheDocument();
  });

  it("renders user initials when no image", async () => {
    const { WorkspaceLayoutHeader } = await import("@/components/dashboard/workspace/layout/WorkspaceLayoutHeader");
    render(
      <WorkspaceLayoutHeader
        session={{ user: { name: "Alice" } } as any}
