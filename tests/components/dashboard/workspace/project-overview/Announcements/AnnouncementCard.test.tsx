...
describe("AnnouncementCard", () => {
  it("renders announcement with title and author", async () => {
    const { AnnouncementCard } = await import("@/components/dashboard/workspace/project-overview/Announcements/AnnouncementCard");
    render(
      <AnnouncementCard
        announcement={{
          id: "1",
          title: "New Update",
          content: "This is a long announcement content that exceeds the character limit for showing the read more link",
          visibility: "PUBLIC",
          isPinned: true,
          createdAt: "2026-07-01T00:00:00Z",
          createdBy: { name: "Alice", email: "a@b.com" },
          targets: [{ userId: "1", user: { name: "Bob" } }],
        } as any}
        canManage
        pinningId={null}
        deletingId={null}
