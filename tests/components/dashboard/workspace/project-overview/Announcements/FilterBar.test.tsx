...
describe("FilterBar", () => {
  it("renders filter tabs", async () => {
    const { FilterBar } = await import("@/components/dashboard/workspace/project-overview/Announcements/FilterBar");
    render(
      <FilterBar active="all" onChange={vi.fn()} total={10} isFetching={false} />
    );
  ...
  it("calls onChange when tab clicked", async () => {
    ...
    const { FilterBar } = await import("@/components/dashboard/workspace/project-overview/Announcements/FilterBar");
    render(
      <FilterBar active="all" onChange={onChange} total={10} isFetching={false} />
    );
