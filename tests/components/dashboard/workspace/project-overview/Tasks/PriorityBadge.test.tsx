...
describe('Workspaces/project/Tasks – PriorityBadge', () => {
  it('renders LOW', async () => {
    const { PriorityBadge } = await import('@/components/dashboard/workspace/project-overview/Tasks/PriorityBadge')
  ...
  it('renders HIGH', async () => {
    const { PriorityBadge } = await import('@/components/dashboard/workspace/project-overview/Tasks/PriorityBadge')
    render(<PriorityBadge priority="HIGH" />)
    expect(screen.getByText('High')).toBeInTheDocument()
  })
  it('renders URGENT', async () => {
    const { PriorityBadge } = await import('@/components/dashboard/workspace/project-overview/Tasks/PriorityBadge')
