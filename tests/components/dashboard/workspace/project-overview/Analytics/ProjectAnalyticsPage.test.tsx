...
describe("ProjectAnalyticsPage", () => {
  it("renders full analytics page", async () => {
    const { ProjectAnalyticsPage } = await import("@/components/dashboard/workspace/project-overview/Analytics/ProjectAnalyticsPage");
    render(
