...
describe('Workspaces/project/Settings – GeneralTab', () => {
  ...
  it('renders project info section', async () => {
    const { GeneralTab } = await import('@/components/dashboard/workspace/project-overview/Settings/GeneralTab')
  ...
  it('renders project name input', async () => {
    const { GeneralTab } = await import('@/components/dashboard/workspace/project-overview/Settings/GeneralTab')
    render(<GeneralTab project={{ id: 'p1', name: 'My Project', description: '' } as any} canManage={true} />)
  ...
  it('hides save button when cannot manage', async () => {
    const { GeneralTab } = await import('@/components/dashboard/workspace/project-overview/Settings/GeneralTab')
