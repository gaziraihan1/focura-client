...
describe('Workspaces/project/Settings – RoleBadge', () => {
  it('renders MANAGER badge', async () => {
    const { RoleBadge } = await import('@/components/dashboard/workspace/project-overview/Settings/RoleBadge')
    render(<RoleBadge role="MANAGER" />)
    expect(screen.getByText('MANAGER')).toBeInTheDocument()
  })
  it('renders COLLABORATOR badge', async () => {
    const { RoleBadge } = await import('@/components/dashboard/workspace/project-overview/Settings/RoleBadge')
    render(<RoleBadge role="COLLABORATOR" />)
    expect(screen.getByText('COLLABORATOR')).toBeInTheDocument()
  })
  it('renders VIEWER badge', async () => {
    const { RoleBadge } = await import('@/components/dashboard/workspace/project-overview/Settings/RoleBadge')
