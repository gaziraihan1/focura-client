...
import { ProjectMembersPanel } from "@/components/dashboard/workspace/members/ProjectMembersPanel";
...
vi.mock("@/components/dashboard/workspace/members/RoleDropdown", () => ({
...
vi.mock("@/components/dashboard/workspace/members/RoleBadge", () => ({
