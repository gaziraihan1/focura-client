...
import { NotificationLoadingState } from '@/components/dashboard/notifications/NotificationLoadingState'
import { NotificationDropdownFooter } from '@/components/dashboard/notifications/NotificationDropdownFooter'
import { NotificationDropdownHeader } from '@/components/dashboard/notifications/NotificationDropdownHeader'
...
describe('Notification States', () => {
  describe('NotificationEmptyState', () => {
    it('renders no notifications message', () => {
      render(<EmptyState icon={Bell} title="No notifications yet" description="We'll notify you when something happens" />)
