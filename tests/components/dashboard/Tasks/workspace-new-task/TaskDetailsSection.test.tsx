...
vi.mock('@/components/dashboard/tasks/workspace-new-task/IntentSelector', () => ({
...
vi.mock('@/components/dashboard/tasks/workspace-new-task/TaskDetailsSection/StatusDetailsSection', () => ({
  default: () => <div data-testid="status-section" />,
}));

vi.mock('@/components/dashboard/tasks/workspace-new-task/TaskDetailsSection/PriorityDetailsSection', () => ({
