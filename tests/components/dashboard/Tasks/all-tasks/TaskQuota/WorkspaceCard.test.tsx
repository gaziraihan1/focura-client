...
vi.mock('@/components/dashboard/tasks/all-tasks/TaskQuota/StartPill', () => ({
  StatPill: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="stat-pill" {...props} />,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQuota/ProgressRing', () => ({
  ProgressRing: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="progress-ring" {...props} />,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQuota/MemberRow', () => ({
...
import { WorkspaceCard } from '@/components/dashboard/tasks/all-tasks/TaskQuota/WorkspaceCard'
