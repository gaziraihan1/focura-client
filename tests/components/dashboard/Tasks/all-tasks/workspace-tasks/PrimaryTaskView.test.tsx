...
import { PrimaryTasksView } from '@/components/dashboard/tasks/all-tasks/workspace-tasks/PrimaryTaskView'
...
vi.mock('@/components/dashboard/tasks/all-tasks/workspace-tasks/RemovalTaskCard', () => ({
