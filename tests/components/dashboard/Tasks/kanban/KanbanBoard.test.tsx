...
vi.mock('@/components/dashboard/tasks/kanban/KanbanBoard/MobileColumnNavigator', () => ({
  MobileColumnNavigator: () => <div data-testid="mobile-navigator" />,
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanBoard/KanbanBoardLoadingState', () => ({
  KanbanBoardLoadingState: () => <div data-testid="loading-state">Loading...</div>,
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanBoard/KanbanColumnsContainer', () => ({
