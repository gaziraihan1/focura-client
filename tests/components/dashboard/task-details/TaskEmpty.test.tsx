...
describe('TaskDetails/TaskEmpty', () => {
  it('renders not found message', async () => {
    const TaskEmpty = (await import('@/components/dashboard/task-details/TaskEmpty')).default
    render(<TaskEmpty />)
  ...
  it('renders back link', async () => {
    ...
    expect(link.closest('a')).toHaveAttribute('href', '/dashboard/tasks')
  })
})
