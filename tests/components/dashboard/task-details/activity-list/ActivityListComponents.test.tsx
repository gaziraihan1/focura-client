...
import { ActivityIcon } from '@/components/dashboard/task-details/ActivityList/ActivityIcon'
...
vi.mock('@/components/dashboard/task-details/ActivityList/UserAvatar', () => ({
...
describe('EmptyState', () => {
  it('renders no activity message', () => {
    render(<EmptyState icon={Clock} title="No activity yet" description="Activity will appear here as changes are made" />)
