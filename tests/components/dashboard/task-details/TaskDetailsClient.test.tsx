...
describe('TaskDetails/TaskDetailsClient', () => {
  it('renders without crashing', async () => {
    const { TaskDetailsClient } = await import('@/components/dashboard/task-details/TaskDetailsClient')
    const { container } = render(<TaskDetailsClient id="t1" workspaceSlug="ws" />)
