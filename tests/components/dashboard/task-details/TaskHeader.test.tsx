...
describe('TaskDetails/TaskHeader', () => {
  it('renders Back button', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} />)
    expect(screen.getByText('Back')).toBeInTheDocument()
  })
  it('renders Edit button when not editing and canEdit', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} canEdit={true} />)
    expect(screen.getByText('Edit')).toBeInTheDocument()
  })
  it('hides Edit when editing', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={true} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} />)
    expect(screen.queryByText('Edit')).not.toBeInTheDocument()
  })
  it('hides Edit when cannotEdit', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} canEdit={false} />)
    expect(screen.queryByText('Edit')).not.toBeInTheDocument()
  })
  it('renders Delete button when canDelete', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} canDelete={true} />)
    expect(screen.getByText('Delete')).toBeInTheDocument()
  })
  it('hides Delete when cannotDelete', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} canDelete={false} />)
    expect(screen.queryByText('Delete')).not.toBeInTheDocument()
  })
  it('shows loading spinner when deleting', async () => {
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={true} />)
    expect(screen.getByTestId('icon-Loader2')).toBeInTheDocument()
  })
  it('calls onBack when Back clicked', async () => {
    const onBack = vi.fn()
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={onBack} onEdit={vi.fn()} onDelete={vi.fn()} isDeleting={false} />)
  ...
  it('calls onEdit when Edit clicked', async () => {
    const onEdit = vi.fn()
    const { TaskHeader } = await import('@/components/dashboard/task-details/TaskHeader')
    render(<TaskHeader isEditing={false} onBack={vi.fn()} onEdit={onEdit} onDelete={vi.fn()} isDeleting={false} />)
