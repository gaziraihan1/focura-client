...
import { SubtaskRow } from '@/components/dashboard/task-details/SubtasksSection/SubtaskRow';
...
vi.mock('@/components/dashboard/task-details/SubtasksSection/StatusButton', () => ({
  StatusButton: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="status-button" data-status={props.status} />,
}));

vi.mock('@/components/dashboard/task-details/SubtasksSection/InlineEditor', () => ({
