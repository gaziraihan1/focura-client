...
describe('TaskDetails/TaskTab – TaskTabHeader', () => {
  it('renders all three tabs', async () => {
    const TaskTabHeader = (await import('@/components/dashboard/task-details/tabs/TaskTabHeader')).default
...
describe('TaskDetails/TaskTab – EmptyComments', () => {
  it('renders no comments message', async () => {
    const { EmptyComments } = await import('@/components/dashboard/task-details/tabs/CommentsList/EmptyComments')
...
describe('TaskDetails/TaskTab – CommentContent', () => {
  it('renders plain text', async () => {
    const { CommentContent } = await import('@/components/dashboard/task-details/tabs/CommentsList/CommentContent')
...
describe('TaskDetails/TaskTab – RelativeTime', () => {
  it('renders relative time', async () => {
    const { RelativeTime } = await import('@/components/dashboard/task-details/tabs/CommentsList/RelativeTime')
...
describe('TaskDetails/TaskTab – MentionDropdown', () => {
  it('renders users list', async () => {
    const { MentionDropdown } = await import('@/components/dashboard/task-details/tabs/MentionDropdown')
    render(
      <MentionDropdown
        users={[
...
describe('TaskDetails/TaskTab – CommentEditor', () => {
  ...
  it('renders lock message when cannot comment', async () => {
    const { CommentEditor } = await import('@/components/dashboard/task-details/tabs/CommentEditor')
...
describe('TaskDetails/TaskTab – CommentsTab', () => {
  ...
  it('renders editor at bottom', async () => {
    const { CommentsTab } = await import('@/components/dashboard/task-details/tabs/CommentsTab')
    render(
      <CommentsTab
...
describe('TaskDetails/TaskTab – AttachmentsTab', () => {
  ...
  it('renders upload area', async () => {
    const { AttachmentsTab } = await import('@/components/dashboard/task-details/tabs/AttachmentsTab')
