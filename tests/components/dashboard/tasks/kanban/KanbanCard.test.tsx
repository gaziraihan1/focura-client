...
import { KanbanCard } from '@/components/dashboard/tasks/kanban/KanbanCard';
...
vi.mock('@/components/dashboard/tasks/kanban/KanbanCard/KanbanCardHeader', () => ({
  KanbanCardHeader: () => <div data-testid="card-header" />,
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanCard/KanbanCardTitle', () => ({
  KanbanCardTitle: ({ title }: { title: string }) => (
    <div data-testid="card-title">{title}</div>
  ),
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanCard/KanbanCardMetadata', () => ({
  KanbanCardMetadata: () => <div data-testid="card-metadata" />,
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanCard/KanbanCardFooter', () => ({
  KanbanCardFooter: () => <div data-testid="card-footer" />,
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanCard/KanbanCardProjectIndicator', () => ({
