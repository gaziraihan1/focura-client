...
import { KanbanColumn } from '@/components/dashboard/tasks/kanban/KanbanColumn';
import type { Task } from '@/hooks/useTask';
import type { ColumnConfig } from '@/hooks/useKanbanBoard';

// ─── Mocks ────────────────────────────────────────────────────────────────────

vi.mock('@/components/dashboard/tasks/kanban/KanbanCard', () => ({
  KanbanCard: ({ task }: { task: Task }) => (
    <div data-testid="kanban-card">{task.title}</div>
  ),
}));

vi.mock('@/components/dashboard/tasks/kanban/KanbanColumn/KanbanColumnHeader', () => ({
  __esModule: true,
...
vi.mock('@/components/dashboard/tasks/kanban/KanbanColumn/EmptyKanbanColumnState', () => ({
  __esModule: true,
