...
vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/StartPill', () => ({
  StatPill: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="stat-pill" {...props} />,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/ProgressRing', () => ({
  ProgressRing: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="progress-ring" {...props} />,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/MemberRow', () => ({
  MemberRow: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="member-row" {...props} />,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/QoutaSkeleton', () => ({
...
import { WorkspaceCard } from '@/components/dashboard/tasks/all-tasks/TaskQouta/WorkspaceCard'
