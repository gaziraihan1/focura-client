...
import TaskQuotaDetails, {
  formatResetTime,
  getPlanBadgeBg,
} from '@/components/dashboard/tasks/all-tasks/TaskQoutaDetails'
...
vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/WorkspaceCard', () => ({
  WorkspaceCard: (props: React.HTMLAttributes<HTMLDivElement>) => <div data-testid="WorkspaceCard">Workspace</div>,
}))

vi.mock('@/components/dashboard/tasks/all-tasks/TaskQouta/PersonalCard', () => ({
