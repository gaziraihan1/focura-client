...
vi.mock('@/components/dashboard/tasks/all-tasks/workspace-tasks/TaskCard', () => ({
  TaskCard: ({ task }: { task: unknown }) => <div data-testid="task-card">{task.title}</div>,
}));

import { RemovableTaskCard } from '@/components/dashboard/tasks/all-tasks/workspace-tasks/RemovalTaskCard';
