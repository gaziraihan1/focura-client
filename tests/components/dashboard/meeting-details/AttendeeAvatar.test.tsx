...
describe("AttendeeAvatar", () => {
  it("renders attendee with name and email", async () => {
    const { AttendeeAvatar } = await import("@/components/dashboard/meeting-details/AttendeeAvatar");
    render(
      <AttendeeAvatar user={{ id: "1", name: "Bob", email: "b@t.com" }} joinedAt="2026-07-01T10:00:00Z" />
    );
