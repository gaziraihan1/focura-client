...
describe("MeetingInfoRow", () => {
  it("renders icon, label, and children", async () => {
    const { InfoRow } = await import("@/components/dashboard/meeting-details/InfoRow");
    render(
      <InfoRow icon={vi.fn(() => <span data-testid="icon" />)} label="Date">
        July 15, 2026
      </InfoRow>
    );
