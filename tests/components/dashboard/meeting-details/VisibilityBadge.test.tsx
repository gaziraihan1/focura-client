...
describe("VisibilityBadge", () => {
  it("renders public visibility", async () => {
    const { VisibilityBadge } = await import("@/components/dashboard/meeting-details/VisibilityBadge");
    render(<VisibilityBadge visibility="PUBLIC" />);
    expect(screen.getByText("Public")).toBeInTheDocument();
  });

  it("renders private visibility", async () => {
    const { VisibilityBadge } = await import("@/components/dashboard/meeting-details/VisibilityBadge");
