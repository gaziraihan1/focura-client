...
describe("HostChip", () => {
  it("renders host name and badge", async () => {
    const { HostChip } = await import("@/components/dashboard/meeting-details/HostChip");
    render(<HostChip user={{ id: "1", name: "Alice", email: "a@b.com" }} />);
