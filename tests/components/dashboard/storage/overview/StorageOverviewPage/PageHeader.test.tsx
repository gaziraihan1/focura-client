...
vi.mock('@/components/dashboard/storage/overview/WorkspaceSwitcher', () => ({
...
import { PageHeader } from '@/components/dashboard/storage/overview/StorageOverviewPage/PageHeader';
