...
describe("TeamTaskProjectInfo", () => {
  it("renders workspace and project name", async () => {
    const { TeamTaskProjectInfo } = await import("@/components/dashboard/team-task/TaskCardTeam/TeamTaskProjectInfo");
    render(
      <TeamTaskProjectInfo workspaceName="My Workspace" projectName="Project X" />
    );
