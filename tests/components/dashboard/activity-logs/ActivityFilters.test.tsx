...
describe('ActivityLogs/ActivityFilters', () => {
  it('renders filter controls', async () => {
    const { ActivityFilters } = await import('@/components/dashboard/activity-logs/ActivityFilters')
    render(<ActivityFilters filters={{ action: 'ALL', entityType: 'ALL' }} onFiltersChange={vi.fn()} />)
