...
import { TermsHighlight } from '@/components/TermsAndConditions/TermsHighlight'

describe('TermsHighlight', () => {
  it('renders with info variant', () => {
    render(<TermsHighlight variant="info">Info content</TermsHighlight>)
    expect(screen.getByText('Info content')).toBeInTheDocument()
  })

  it('renders with warning variant', () => {
    render(<TermsHighlight variant="warning">Warning content</TermsHighlight>)
    expect(screen.getByText('Warning content')).toBeInTheDocument()
  })

  it('renders with success variant', () => {
    render(<TermsHighlight variant="success">Success content</TermsHighlight>)
