...
import TermsContentDefault from '@/components/TermsAndConditions/TermsContent'

describe('TermsContent', () => {
  it('renders all section headings', () => {
    render(<TermsContentDefault />)
    expect(screen.getByText('Introduction')).toBeInTheDocument()
    expect(screen.getByText('Eligibility & Account Registration')).toBeInTheDocument()
    ...
    expect(screen.getByText('Termination & Suspension')).toBeInTheDocument()
    expect(screen.getByText('Disclaimers & Limitation of Liability')).toBeInTheDocument()
    expect(screen.getByText('Changes to These Terms')).toBeInTheDocument()
    expect(screen.getByText('Governing Law & Disputes')).toBeInTheDocument()
