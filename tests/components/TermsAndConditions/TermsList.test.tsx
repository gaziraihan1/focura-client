...
import { TermsList } from '@/components/TermsAndConditions/TermsList'

describe('TermsList', () => {
  it('renders unordered list by default', () => {
    const { container } = render(<TermsList items={['A', 'B']} />)
    expect(container.querySelector('ul')).toBeInTheDocument()
  })

  it('renders ordered list when specified', () => {
    const { container } = render(<TermsList items={['A', 'B']} ordered />)
    expect(container.querySelector('ol')).toBeInTheDocument()
  })

  it('renders all items', () => {
    render(<TermsList items={['One', 'Two', 'Three']} />)
