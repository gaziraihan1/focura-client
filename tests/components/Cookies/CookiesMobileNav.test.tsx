...
describe('CookiesMobileNav', () => {
  it('renders "Jump to section"', () => {
    render(<CookiesMobileNav items={[{ id: 'a', label: 'Alpha' }]} />)
    expect(screen.getByText('Jump to section')).toBeInTheDocument()
  })

  it('toggles open and shows items', () => {
    render(<CookiesMobileNav items={[{ id: 'a', label: 'Alpha' }, { id: 'b', label: 'Beta' }]} />)
