...
describe("AdminEmptyState", () => {
  it("renders user not found with link", async () => {
    const { EmptyState } = await import("@/components/admin-dashboard/user/EmptyState");
    render(<EmptyState />);
    expect(screen.getByText("User not found")).toBeInTheDocument();
    expect(screen.getByText("Back to users")).toHaveAttribute("href", "/admin-dashboard/users");
  });
});
