...
describe("UserStatCard", () => {
  it("renders value, label, and sub text", async () => {
    const { StatCard } = await import("@/components/admin-dashboard/user/StatCard");
    render(
      <StatCard icon={vi.fn(() => null)} label="Tasks" value={42} sub="This week" />
    );
