...
describe("StatusSelect", () => {
  it("renders status options", async () => {
    const { StatusSelect } = await import("@/components/admin-dashboard/resource/StatusSelect");
    render(<StatusSelect id="test-sel" value="DRAFT" onChange={vi.fn()} />);
