...
describe("DeleteConfirmModal", () => {
  it("renders delete confirmation", async () => {
    const { DeleteConfirmModal } = await import("@/components/admin-dashboard/resource/DeleteConfirmationModal");
    render(
      <DeleteConfirmModal
        title="My Item"
        onConfirm={vi.fn()}
  ...
  it("calls onCancel when cancel clicked", async () => {
    ...
    const { DeleteConfirmModal } = await import("@/components/admin-dashboard/resource/DeleteConfirmationModal");
    render(
      <DeleteConfirmModal title="X" onConfirm={vi.fn()} onCancel={onCancel} />
    );
  ...
  it("calls onConfirm when delete clicked", async () => {
    ...
    const { DeleteConfirmModal } = await import("@/components/admin-dashboard/resource/DeleteConfirmationModal");
    render(
      <DeleteConfirmModal title="X" onConfirm={onConfirm} onCancel={vi.fn()} />
    );
