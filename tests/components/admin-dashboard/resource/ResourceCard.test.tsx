...
describe("ResourceCard", () => {
  it("renders title, subtitle, badge", async () => {
    const { ResourceCard } = await import("@/components/admin-dashboard/resource/ResourceCard");
    render(
      <ResourceCard
        title="Test Resource"
        subtitle="A subtitle"
  ...
  it("opens delete confirm modal on delete click", async () => {
    const { ResourceCard } = await import("@/components/admin-dashboard/resource/ResourceCard");
    render(
      <ResourceCard title="Res" onEdit={vi.fn()} onDelete={vi.fn()} />
    );
