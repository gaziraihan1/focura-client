...
vi.mock("@/components/admin-dashboard/careers/AdminJobTable", () => ({
  default: () => <div data-testid="admin-job-table" />,
}));

vi.mock("@/components/admin-dashboard/careers/AdminJobForm", () => ({
...
import AdminJobManager from "@/components/admin-dashboard/careers/AdminJobManager";
