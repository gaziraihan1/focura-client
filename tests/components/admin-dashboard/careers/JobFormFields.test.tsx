...
describe("JobFormFields", () => {
  it("renders JobField with error", async () => {
    const { JobField } = await import("@/components/admin-dashboard/careers/JobFormFields");
    render(
      <JobField label="Title" error="Required" required>
        <input />
      </JobField>
    );
  ...
  it("renders hint when no error", async () => {
    const { JobField } = await import("@/components/admin-dashboard/careers/JobFormFields");
    render(
      <JobField label="Name" hint="Helpful hint">
        <input />
      </JobField>
    );
