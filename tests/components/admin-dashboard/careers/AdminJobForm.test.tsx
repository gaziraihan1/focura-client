...
describe("AdminJobForm", () => {
  it("renders form with default fields", async () => {
    const { AdminJobForm } = await import("@/components/admin-dashboard/careers/AdminJobForm");
    render(<AdminJobForm onSubmit={vi.fn()} submitLabel="Save" />);
