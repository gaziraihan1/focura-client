...
describe("ApiDocsEndpointCardParts", () => {
  ...
  it("CopyButton copies text and shows check", async () => {
    const { CopyButton } = await import("@/components/ApiDocs/ApiDocsEndpointCardParts");
  ...
  it("ParamsTable renders required and optional params", async () => {
    const { ParamsTable } = await import("@/components/ApiDocs/ApiDocsEndpointCardParts");
    render(
      <ParamsTable
        title="Path Params"
        params={[
  ...
  it("ResponseList renders status codes with colors", async () => {
    const { ResponseList } = await import("@/components/ApiDocs/ApiDocsEndpointCardParts");
    render(
      <ResponseList
        responses={[
  ...
  it("CodeExamples switches tabs and copies", async () => {
    const { CodeExamples } = await import("@/components/ApiDocs/ApiDocsEndpointCardParts");
    const writeText = vi.fn().mockResolvedValue(undefined);
    Object.assign(navigator, { clipboard: { writeText } });
    render(
      <CodeExamples
