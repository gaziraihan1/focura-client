...
export const templatesSection: ApiSection = {
  ...
  endpoints  : [
    ...
    },
    {
      ...
      description: 'Gablura-admin only. Returns all template waitlist emails.',
      auth       : 'admin',
      responses  : [
    ...
    },
    {
      ...
      description: 'Gablura-admin only. Idempotent removal of a waitlist email by address.',
      auth       : 'admin',
    ...
    },
    {
      ...
      description: 'Update title/description/tier/etc. of a template you authored (or a Gablura admin).',
      auth       : 'auth',
      pathParams : [ { name: "slug", type: "string", required: true, description: "Template slug" } ],
    ...
    },
    {
      ...
      description: 'Deletes a template you authored (or a Gablura admin).',
      auth       : 'auth',
      pathParams : [ { name: "slug", type: "string", required: true, description: "Template slug" } ],
