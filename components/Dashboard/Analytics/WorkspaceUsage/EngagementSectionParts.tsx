...
import type { ActiveUserStat } from "./EngagementSection";
...
export function ActiveUserCards({ stats }: { stats: ActiveUserStat[] }) {
  return (
...
export function DailyActiveUsersChart({ chartData }: { chartData: { date: string; users: number }[] }) {
  return (
...
export function InactiveMembers({ users }: { users: UserEngagementMetrics["inactiveUsers"] }) {
...
export function CollaborationLeaderboard({
  leaderboard,
  searchQuery,
  onSearchChange,
}: {
  leaderboard: UserEngagementMetrics["collaborationIndex"];
  searchQuery: string;
