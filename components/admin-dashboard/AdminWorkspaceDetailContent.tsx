...
import { DeleteWorkspaceModal } from '@/components/admin-dashboard/workspace/DeleteWorkspaceModal';
...
export function AdminWorkspaceDetailContent({ workspaceSlug }: { workspaceSlug: string }) {
  const { data: ws, isLoading } = useAdminWorkspaceDetail(workspaceSlug);
