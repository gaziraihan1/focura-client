...
export const overviewArticles: GuideArticle[] = [
  {
    id: "tech-stack",
    title: "Tech stack",
    summary:
      "Next.js 16 + React 19 frontend with an Express.js backend, TypeScript throughout, Prisma + PostgreSQL, Upstash Redis caching and Server-Sent Events.",
    content: (
      <>
        <Prose>
  ...
  },
  {
    ...
    summary:
      "Self-contained modules under src/modules — activity, analytics, attachment, calendar, comment, dailyTask, fileManagement, focusSession, label, notification, project, storage, task, upload and workspace.",
    content: (
      <>
        ...
        <Tip>
          Every module is self-contained. Adding a new domain feature means creating a new folder
          under <IC>src/modules/</IC> — you never touch other modules.
        </Tip>
      </>
    ),
  },
