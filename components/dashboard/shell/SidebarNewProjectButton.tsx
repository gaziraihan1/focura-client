  ...
  return (
    <>
      <Button
        ...
        className='h-auto w-full justify-start gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold border border-sidebar-border bg-sidebar-accent/40 text-sidebar-foreground hover:bg-sidebar-accent/70'
      >
          ...
          <div className='w-full max-w-lg rounded-2xl border border-border bg-card shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200'>
            ...
            <div className='flex items-start justify-between gap-3 px-5 pt-5 pb-4 border-b border-border'>
              ...
              <Button
                ...
                onClick={close}
                aria-label='Close'
                className='h-auto w-auto shrink-0 p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent'
              >
                <X className='w-4 h-4' />
              </Button>
            </div>
                          ...
                          {locked ? (
                            <div className='flex items-center justify-between gap-2 pt-1'>
                              ...
                              <Button variant="primary" size="sm"
                                ...
                                className="shrink-0 rounded-lg px-2.5 py-1.5 text-[11px] font-bold gap-1"
                              >
                            ...
                            <Button variant="primary" size="sm"
                              ...
                              className="w-full rounded-lg px-3 py-2 text-xs font-bold gap-1.5"
                            >
                              {busy ? (
            ...
            <div className='px-5 py-4 border-t border-border flex items-center justify-between gap-3'>
              ...
              <Button variant="secondary" size="sm"
                onClick={handleBlank}
                className="shrink-0 rounded-xl px-4 py-2 text-xs font-bold gap-1.5"
              >
