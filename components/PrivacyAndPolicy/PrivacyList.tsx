...
export const PrivacyList = ({ items, ordered = false, className }: PrivacyListProps) => {
  const Tag = ordered ? "ol" : "ul";

  return (
    <Tag className={cn("space-y-2 text-sm text-neutral-600 dark:text-neutral-400", className)}>
      {items.map((item, i) => (
