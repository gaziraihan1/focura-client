...
type PrivacyHighlightVariant = "info" | "warning" | "success";

interface PrivacyHighlightProps {
  children: ReactNode;
  variant?: PrivacyHighlightVariant;
}
...
const styles: Record<PrivacyHighlightVariant, string> = {
