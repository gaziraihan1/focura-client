...
type RefundHighlightVariant = "info" | "warning" | "success";

interface RefundHighlightProps {
  children: ReactNode;
  variant?: RefundHighlightVariant;
}
...
const styles: Record<RefundHighlightVariant, string> = {
...
export const RefundHighlight = ({
  children,
  variant = "info",
}: RefundHighlightProps) => {
