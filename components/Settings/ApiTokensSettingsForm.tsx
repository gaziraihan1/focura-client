      ...
      {showNewToken && newTokenValue ? (
        ...
        <div className="flex items-end gap-3">
          <div className="flex-1">
            <label className="block text-xs font-medium text-muted-foreground mb-2" htmlFor="fld-63">
              Token Name
            </label>
            <input id="fld-63"
              type="text"
...
function TokenListCard({ tokens, isPending, onDelete }: TokenListCardProps) {
  return (
    <div className="rounded-2xl border border-border bg-card p-4">
      <div className="flex items-center gap-3 mb-6">
...
interface DocsCardProps {
  activeTab: 'usage' | 'examples' | 'security';
  onTabChange: (tab: 'usage' | 'examples' | 'security') => void;
}

function DocsCard({ activeTab, onTabChange }: DocsCardProps) {
  return (
    <div className="rounded-2xl border border-border bg-card p-4">
      <div className="flex items-center gap-3 mb-6">
...
const handleDeleteConfirm = async () => {
  ...
  return (
    <div className="space-y-8">
      {/* New Token */}
      <NewTokenCard
        showNewToken={showNewToken}
        newTokenValue={newTokenValue}
        newTokenName={newTokenName}
        isPending={createToken.isPending}
        onChangeName={setNewTokenName}
        onCreate={handleCreate}
        onCopy={copyToken}
        onDismiss={() => { setShowNewToken(false); setNewTokenValue(null); }}
      />
      ...
      {/* Documentation */}
      <DocsCard activeTab={activeTab} onTabChange={setActiveTab} />
