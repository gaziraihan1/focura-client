...
import { AlertCircle, Calendar, CheckCircle2, Clock, Flag, Folder, Timer, TrendingUp } from "lucide-react";
...
export function TitleBlock({
  ...
  /** Tailwind class applied on group hover; override for themed variants. */
  hoverClass?: string;
}) {
  return (
    ...
    <div className="mt-4 flex flex-wrap items-center gap-2">
      ...
      {showTimeTracking && task.timeTracking && (
        <span className="inline-flex items-center gap-1 text-xs text-muted-foreground">
          ...
          {/* hoursSinceCreation is a number of hours; formatTimeDuration
              renders it as "3h" / "2d 4h". The previous code fed this number
              into formatHoursSinceCreation (which expects a date string),
