  ...
  return (
    <motion.div className="rounded-xl bg-card border border-border p-6 space-y-5">
      ...
      {focusRequired && (
        <>
          <div>
            <label className="text-sm mb-2 block" htmlFor="fld-70">Focus Level (1–5)</label>
            <input id="fld-70"
              type="range"
              min={1}
              max={5}
          ...
          <div>
            <span className="text-sm mb-2 block">Energy Required</span>
          ...
          <div>
            <label className="text-sm mb-2 block" htmlFor="fld-71">Distraction Cost</label>
            <input id="fld-71"
              type="number"
              min={0}
              max={5}
