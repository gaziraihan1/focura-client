            ...
            <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 overflow-hidden">
              ...
              <div className="px-6 pb-6">
                <div className="-mt-7 mb-4">
                  <div className="w-14 h-14 rounded-2xl bg-neutral-900 dark:bg-neutral-50 border-2 border-white dark:border-neutral-900 flex items-center justify-center shadow-md">
                    <span className="text-white dark:text-neutral-900 text-lg font-bold">
                      MR
                    </span>
                  </div>
                </div>
